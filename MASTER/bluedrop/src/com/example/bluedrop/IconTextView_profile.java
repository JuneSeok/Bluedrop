...
public class IconTextView_profile extends LinearLayout {
	...
	public IconTextView_profile(Context context, IconTextItem_profile aItem) {
		super(context);
		
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.listitem_profile, this, true);  
